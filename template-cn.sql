...
(91,2,'超级跳跃','- 第一段跳高度增加'),
(92,10,'农耕经验','- 农耕经验'),
(93,4,'农耕盲盒','- 随机获得农耕经验、随机盲盒、超级跳、神器等'),
(94,12,'称号 任务达人','- +1500生命、500护甲'),
(95,5,'木材','- 用于合成'),
(96,5,'铜矿石','- 用于合成'),
(97,6,'铜镐','- 用于挖矿'),
(98,5,'铁矿石','- 用于合成'),
...
(105,5,'大号木头','- 用于合成'),
(106,5,'龙矿石','- 用于合成'),
(107,3,'灵魂碎片','- 在线奖励中随机得到，25个灵魂碎片可以合成1个灵魂'),
(108,6,'材料','- 用于附魔、商店等'),
(109,10,'萃取经验','- 萃取经验'),
(110,1,'爱心榴弹','- 50%几率消耗1魔能'),
(111,15,'皮革胸甲','- 生命+100,护甲+100'),
(112,16,'皮革鞋子','- 生命+50，护甲+50'),
(113,17,'伤害增强','- 增加伤害'),
(114,15,'铜质胸甲','- 生命+150,护甲+150'),
(115,16,'铜质鞋子','- 生命+100,护甲 +100'),
(116,15,'铁质胸甲','- 生命+200,护甲 +200'),
(117,16,'铁质鞋子','- 生命+150,护甲 +150'),
(118,15,'金质胸甲','- 生命+250,护甲+250'),
(119,16,'金质鞋子','- 生命+150,护甲+150'),
(120,15,'钻石胸甲','- 生命+300,护甲+300'),
(121,16,'钻石鞋子','- 生命+250,护甲+250'),
(122,15,'龙胸甲','- 生命+500,护甲+500'),
(123,16,'龙鞋子','- 生命+400,护甲+400'),
(124,10,'魔法师称号','- 生命+1000,护甲+1000'),
(125,6,'龙斧','- 砍树速度加倍'),
(126,6,'龙锄头','- 种地速度提升'),
(127,5,'精铁','- 用于合成'),
(128,5,'锡矿','- 用于合成'),
(129,2,'自定义颜色','让你使用自己的皮肤颜色');
...
(87,4,'Cabbage','- You got 35 exp'),
(88,4,'Potato','- You got 25 exp'),
(89,4,'Tomate','- You got 15 exp'),
(90,4,'Carrot','- You got 10 exp'),
(91,2,'Jump Impuls','- Impuls jump'),
(92,10,'Farming Exp','- Farming Exp'),
(93,4,'Farming Box','- Random Reward'),
(94,12,'Title Questing System','- 1500 HP | 500 Armor'),
(95,5,'Wood','- Craft Item'),
(96,5,'Cooper Ore','- Craft Item'),
(97,6,'Cooper Pickaxe','- Miner Item'),
(98,5,'Iron Ore','- Craft Item'),
(99,6,'Iron Pickaxe','- Miner Item'),
(100,5,'Gold Ore','- Craft Item'),
(101,6,'Gold Pickaxe','- Miner Item'),
(102,5,'Diamond Ore','- Craft Item'),
(103,6,'Diamond Pickaxe','- Miner Item'),
(104,10,'Miner Exp','- Miner Exp'),
(105,5,'Big Wood','- Craft Item'),
(106,5,'Dragon Ore','- Craft Item'),
(107,3,'Particle Soul','- Event Back to school'),
(108,6,'Material','- Work Item'),
(109,10,'Loader Exp','- Loader Exp'),
(110,1,'Pizdamet','- 50% -1 mana'),
(111,15,'Leather body','(Armor +100, Health +100)'),
(112,16,'Leather feet','- Health +50 Armor +50'),
(113,17,'Stabilized Clasic','- Damaage +1'),
(114,15,'Cooper body','- Health Armor +150'),
(115,16,'Cooper feet','- Health Armor +100'),
(116,15,'Iron body','- Health Armor +200'),
(117,16,'Iron feet','- Health Armor +150'),
(118,15,'Gold body','- Health Armor +250'),
(119,16,'Gold feet','- Health Armor +150'),
(120,15,'Diamond body','- Health Armor +300'),
(121,16,'Diamond feet','- Health Armor +250'),
(122,15,'Dragon body','- Health Armor +500'),
(123,16,'Dragon feet','- Health Armor +400'),
(124,10,'Title Enchanter','- Health Armor +1000'),
(125,6,'Dragon Axe','Cutting wood faster'),
(126,6,'Dragon Hoe','Farming faster'),
(127,5,'Fine Iron','- Item for crafting'),
(128,5,'Stannum Ore','- Item for crafting'),
(129,2,'Custom Color','Use customized tee color');
